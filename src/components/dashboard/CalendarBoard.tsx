...
const CalendarDayCell = ({ date, tasks, dailyRevenue }: { date: Date, tasks: Task[], dailyRevenue: number | null }) => {
...
const CalendarBoard = () => {
    ...
    const revenueByDay = useMemo(() => {
      ...
      operacoes?.forEach(op => {
        ...
        grouped[dayKey] += op.lucroLiquido;
      });
      return grouped;
    }, [operacoes]);
                ...
                <Calendar
                    ...
                    components={{
                        Day: ({ date }) => {
                             ...
                             const dailyRevenue = revenueByDay[dayKey] ?? null;
                             return <CalendarDayCell date={date} tasks={dailyTasks} dailyRevenue={dailyRevenue} />;
                        }
                    }}
                />
            </CardContent>
